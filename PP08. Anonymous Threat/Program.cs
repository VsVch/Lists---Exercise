    ...
    public class Anonymous_Threat
    {
        public static void Main()
        {
            ...
            while (command != "3:1")
            {
                ...
                //Console.WriteLine(string.Join(" ", commandDetails));
                switch (commandDetails[0])
                {
                    case "merge":
                        ...
                        else if (startIndex >= input.Count) {command = Console.ReadLine(); continue;}
                    ...
                    case "divide":
                        ...
                        if (partitions == 0) {command = Console.ReadLine(); continue;}
        ...
        private static List<string> Merge(List<string> input, int startIndex, int endIndex)
        {
            ...
            for (int i = startIndex; i <= endIndex; i++) {sb.Append(input[i]);}
